...
void init_options(py::module &m) {
    ...
    py::class_<PartitionBufferOptions, StorageOptions, std::shared_ptr<PartitionBufferOptions>>(m, "PartitionBufferOptions")
        ...
        .def_readwrite("randomly_assign_edge_buckets", &PartitionBufferOptions::randomly_assign_edge_buckets)
        .def_readwrite("randomize_partition_ids", &PartitionBufferOptions::randomize_partition_ids)
        .def_readwrite("shuffle_buffer_states", &PartitionBufferOptions::shuffle_buffer_states)
        .def_readwrite("inter_gpu_swap", &PartitionBufferOptions::inter_gpu_swap)
        .def_readwrite("mock_num_devices_for_schedule", &PartitionBufferOptions::mock_num_devices_for_schedule);
