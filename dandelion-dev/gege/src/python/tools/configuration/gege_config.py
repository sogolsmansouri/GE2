...
class StorageConfig:
    ...
    edges: StorageBackendConfig = field(default_factory=lambda: StorageBackendConfig(options=StorageOptions(dtype="int")))
    nodes: StorageBackendConfig = field(default_factory=lambda: StorageBackendConfig(options=StorageOptions(dtype="int")))
    embeddings: StorageBackendConfig = field(default_factory=lambda: StorageBackendConfig(options=StorageOptions(dtype="float")))
    features: StorageBackendConfig = field(default_factory=lambda: StorageBackendConfig(options=StorageOptions(dtype="float")))
    prefetch: bool = True
