...
class PartitionBufferOptions(StorageOptions):
    ...
    randomize_partition_ids: bool = True
    shuffle_buffer_states: bool = True
    inter_gpu_swap: bool = False
    mock_num_devices_for_schedule: int = 0
    ...
    def __post_init__(self):
        ...
        if self.mock_num_devices_for_schedule < 0:
            raise ValueError("mock_num_devices_for_schedule must be >= 0")
